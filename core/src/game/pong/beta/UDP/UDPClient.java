...
//			e.printStackTrace();
            System.out.println("Socket timed out: <" + e.getMessage() + ">: at UDP.UDPClient.send(UDPClient.java:38)");
        }
        catch(SocketException se) {
            System.out.println("Socket closed: <" + se.getMessage() + ">: at UDP.UDPClient.send(UDPClient.java:38");
        }
        catch(Exception e){
            e.printStackTrace();
        }finally{
